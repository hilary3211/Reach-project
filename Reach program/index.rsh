...
export const main = Reach.App(() => { //Reach app
  ...
  Alice.only(() => { // the only function makes it possible that only alice plays first
  ...
  while (outcome == DRAW) {
    ...
    Alice.only(() => { //making alice hand public by declassifying it and the publishing it 
